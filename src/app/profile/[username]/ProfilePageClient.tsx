...
import { updateProfile, getUserSavedPosts } from "@/actions/profile.action";
...
import { BookmarkIcon, CalendarIcon, EditIcon, FileTextIcon, HeartIcon, ImageIcon, LinkIcon, MapPinIcon } from "lucide-react";
import { useState } from "react";
import type { ProfilePostsViewModel, ProfileViewModel } from "@/server/view-models/social";

type User = ProfileViewModel;
type Posts = ProfilePostsViewModel;
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="w-full max-w-lg mx-auto">
          <Card className="bg-card overflow-hidden">
            {/* Background Banner */}
            <div
              className="h-32 w-full bg-gradient-to-r from-primary/20 to-primary/5 relative"
              style={
              ...
              {posts.length > 0 ? (
                posts.map((post) => (
                  <PostCard
                    ...
                    canPinPost={viewerDbUserId === post.author.id}
                  />
                ))
              ) : (
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                <Label className="flex items-center gap-1">
                  <ImageIcon className="size-4" /> Background Image
                </Label>
                <ImageUpload
                  endpoint="profileBgUploader"
