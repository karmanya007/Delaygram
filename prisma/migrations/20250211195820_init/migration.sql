...
-- CreateEnum
CREATE TYPE "NotificationScope" AS ENUM ('GLOBAL', 'ROOM');

-- CreateEnum
CREATE TYPE "PostScope" AS ENUM ('GLOBAL', 'ROOM');
...
CREATE TABLE "Post" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "roomId" TEXT,
    "scope" "PostScope" NOT NULL DEFAULT 'ROOM',
...
CREATE TABLE "Notification" (
    ...
    "scope" "NotificationScope" NOT NULL DEFAULT 'ROOM',
    "postId" TEXT,
    "commentId" TEXT,
    "roomId" TEXT,
